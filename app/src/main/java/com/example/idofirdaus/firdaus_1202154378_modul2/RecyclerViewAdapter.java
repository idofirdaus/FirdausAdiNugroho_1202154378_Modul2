                ...
                public void onClick(View view) {
                    ...
                    switch (getAdapterPosition()){
                        case 0 :
                            ...
                            ingredient = "Nasi,Telur,Ayam Goreng,Udang,Cumi,Kerupuk";
                        ...
                        case 2 :
                            ...
                            intent.putExtra("harga",rvHarga.get(getAdapterPosition()));
                            intent.putExtra("gambar",gambar.get(getAdapterPosition()));
                            ingredient = "Daging,Aci,Tepung Tapioka, Mie,Sayur, Tetelan";
                            intent.putExtra("komposisi",ingredient);
                            context.startActivity(intent);
                            break;
                        case 3 :
                            ...
                            intent.putExtra("harga",rvHarga.get(getAdapterPosition()));
                            intent.putExtra("gambar",gambar.get(getAdapterPosition()));
                            ingredient = "Mie,Kecap,Telur,Sosis,Ayam,Sayur,Margarin";
                            intent.putExtra("komposisi",ingredient);
                            context.startActivity(intent);
                            break;
                        case 4 :
                        ...
                        case 6 :
                            ...
                            intent.putExtra("harga",rvHarga.get(getAdapterPosition()));
                            intent.putExtra("gambar",gambar.get(getAdapterPosition()));
                            ingredient = "Gurame,Bumbu Asam Manis ,Bawang Merah,Bawang Putih,Sayur";
                            intent.putExtra("komposisi",ingredient);
                            context.startActivity(intent);
                            break;
